...
def build_template_bytes() -> bytes:
    ...
    ws.sheet_view.rightToLeft = True
    headers = ["קטגוריה", "תיאור", "ספק", "עלות ללא מע״מ (₪)", "הערות"]
    ...
    examples = [
        ["הוצאות דיירים", "פיצויי דיירים", "", 1500000, "פינוי 50 דירות"],
        ["קרקע ומיסוי", "מס רכישה", "רשויות", 850000, ""],
        ["הוצאות עקיפות", "תכנון אדריכלי", "אדריכל א.כ.", 320000, ""],
        ["הוצאות עקיפות", "פיקוח עליון", "מהנדס בנייני", 180000, ""],
        ["בניה ישירה", "בנייה כללית", 'חברת בנייה בע"מ', 18500000, "חוזה ראשי"],
        ["בניה ישירה", "מערכות חשמל", 'חשמל י. בע"מ', 950000, ""],
    ]
